...
- CircuitRush Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called CircuitRush Lite. It should be a full-viewport routing arcade game where the player steers a moving signal through switching junctions, collects charge nodes, avoids overload gates, includes gameplay and settings screens, visible score, level and lives HUD, keyboard and cl…
...
- Gameplay - CircuitRush Lite
- Game Settings - CircuitRush Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - CircuitRush Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - CircuitRush Lite
